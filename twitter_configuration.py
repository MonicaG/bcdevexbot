"""
Calls the Twitter help/configuration API and stores the results.
Should only be run once a day!
"""
import argparse
import configparser
...
if __name__ == '__main__':
    arg_parser = argparse.ArgumentParser(description=(
        'Calls the twitter help/configuration API. '
    ...
    try:
        ...
        logger.exception(
            "twitter_configuration encountered an exception during its run.")
        sys.exit(1)
